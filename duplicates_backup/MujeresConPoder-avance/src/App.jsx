...
import MarketplaceCursos from './components/MarketplaceCursos.jsx';

const HeroSection = () => {
  return (
    <section className="text-center p-5 position-relative" id="inicio" style={{ backgroundColor: '#FDF2F8' }}>
      <div className="container py-5">
        <h1 className="display-4 fw-bold">
          <span style={{ color: '#F472B6' }}>Crece a tu propio ritmo</span>
        </h1>
        <h2 className="h4 fw-normal mb-4" style={{ color: '#831843' }}>
          con tu propia red
        </h2>

        <p className="lead mx-auto mb-4 fw-bold" style={{ maxWidth: '600px', color: '#BE185D' }}>
          Tu talento, nuestras herramientas. Encuentra la formación, el mercado y el respaldo financiero que
          necesitas para llevar tu negocio al siguiente nivel. Un ecosistema creado por y para mujeres que no se
          detienen.
        </p>
  ...
  return (
    <section className="container py-5 text-center">
      <h3 className="fw-bold mb-4">
        Todo lo que necesitas, <br /> <span style={{ color: '#F472B6' }}>JUNTO</span>
      </h3>
...
const OpportunitiesBanner = () => {
  return (
    <section className="container py-5 mb-5" id="oportunidades">
      <div className="p-5 rounded-4 text-center shadow-sm" style={{ backgroundColor: '#bbf7d0' }}>
        ...
        <p className="mx-auto mb-4" style={{ maxWidth: '700px' }}>
          Descubre empleos, becas, convocatorias de programas de gobierno, financiamiento y mentorías todo
          específicamente para mujeres emprendedoras.
        </p>
...
const App = () => {
  useEffect(() => {
    ...
    irASeccionActual();
    window.addEventListener('hashchange', irASeccionActual);

    return () => {
      window.removeEventListener('hashchange', irASeccionActual);
    };
  }, []);
